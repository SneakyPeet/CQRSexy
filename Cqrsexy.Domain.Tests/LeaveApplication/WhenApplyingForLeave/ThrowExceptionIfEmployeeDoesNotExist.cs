...
{
    public class ThrowExceptionIfEmployeeDoesNotExist : Spesification
    {
        ...
        public void Test()
        {
            When(new ApplyForLeave(this.leaveId, this.employeeId, new DateTime(2012, 05, 05), new DateTime(2012, 05, 06)));
        }
    }
}
